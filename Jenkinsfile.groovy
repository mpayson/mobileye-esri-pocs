    ...
    node(label) {
        ...
        stage("Deploy ${chartLocalPath}  in  ${envName} environment ") {
            ...
            withCredentials([usernamePassword(credentialsId: 'mobileye-arcgis', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]) {
                ...
                sh "pip3 install --upgrade mobileye_common==0.0.60 arcgis==1.7.0 --no-deps --extra-index-url 'http://aa-artifactory.intel.com:8081/artifactory/api/pypi/aa-mobileye-pypi-local/simple' --trusted-host aa-artifactory.intel.com"
                map_env = "test"
